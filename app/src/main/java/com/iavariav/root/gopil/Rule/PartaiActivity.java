...
import com.iavariav.root.gopil.Model.FakModel;
...
//        getDataPartai();
    ...
    private void getData() {
        final ProgressDialog loading = ProgressDialog.show(PartaiActivity.this, "Loading", "Mengambil data partai...", false, false);
        ...
        call.enqueue(new Callback<ResponseBody>() {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            containerPartai.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), DetailPartaiActivity.class);
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(PartaiActivity.this, "" + Config.ERROR_NETWORK, Toast.LENGTH_SHORT).show();
            }
        });
    }

//    private void getDataPartai() {
//        final ProgressDialog loading = ProgressDialog.show(PartaiActivity.this, "Loading", "Harap tunggu...", false, false);
//        ApiServiceGas apiServiceGas = ClientGas.getInstanceRetrofit();
//        Call<ArrayList<FakModel>> call = apiServiceGas.getDataPartai();
//        call.enqueue(new Callback<ArrayList<FakModel>>() {
//            @Override
//            public void onResponse(Call<ArrayList<FakModel>> call, Response<ArrayList<FakModel>> response) {
//                FakModels = response.body();
//                Toast.makeText(PartaiActivity.this, "" + FakModels, Toast.LENGTH_SHORT).show();
//                for (int i = 0; i < FakModels.size(); i++) {
//
//                    partaiSekjen = FakModels.get(i).getSekjen();
//                    partaiBendum = FakModels.get(i).getBendum();
//                    partaiKetum = FakModels.get(i).getKetum();
////                    partaiDate = FakModels.get(i).getDate();
//                    partaiSingkatan = FakModels.get(i).getSingkatan();
//                    partaiNama = FakModels.get(i).getNama();
//                    partaiIvGambar = FakModels.get(i).getFotoPartai();
//
//                    loading.dismiss();
//
//                    LayoutInflater layoutInflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//                    final ImageView ivRowGoPilPartai = (ImageView) addView.findViewById(R.id.ivRowPartai);
//
//                    Glide.with(getApplicationContext()).load(partaiIvGambar).error(R.drawable.gopil).crossFade().into(ivRowGoPilPartai);
//
//                    tvRowGoPilPartaiSekjen.setText(partaiSekjen);
//                    tvRowGoPilPartaiBendum.setText(partaiBendum);
//                    tvRowGoPilPartaiKetum.setText(partaiKetum);
//                    tvRowGoPilPartaiDate.setText(partaiDate);
//                    tvRowGoPilPartaiSingkatan.setText(partaiSingkatan);
//                    tvRowGoPilPartaiNama.setText(partaiNama);
//
//                    div.addView(addView);
//
//                }
...
//
//            @Override
//            public void onFailure(Call<ArrayList<FakModel>> call, Throwable t) {
//                loading.dismiss();
//                Toast.makeText(PartaiActivity.this, "" + Config.ERROR_NETWORK, Toast.LENGTH_SHORT).show();
//            }
//        });
